...
const Cart = () => {
  ...
  const {cart} = useSelector((state) => state);    // This method and above commented method are same
    ...
    <div>
      {
        ...
        (
          <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
            ...
            <div className="w-[100%] md:w-[40%] my-5  flex flex-col">
        ...
        (
          <div className="min-h-[80vh] flex flex-col items-center justify-center">
            ...
            <NavLink to="/">
             <button className="uppercase bg-green-600 hover:bg-purple-50 rounded-lg text-white 
